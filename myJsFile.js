...
function checkDate(d) {
    ...
    var flag = true;
    re = /^\d{4}-([1-9]|0[1-9]|1[1-2])-([1-9]|0[1-9]|[1-2][0-9]|3[01])T([1-9]|0[1-9]|1[0-9]|2[0-4]):([0-5][0-9])$/;
...
function setDate() {
  var nowD = new Date();
  var yyyy = nowD.getFullYear().toString();
  var mm = (nowD.getMonth() + 1).toString();
  var dd = nowD.getDate().toString();
  var hr = nowD.getHours().toString();
  var min = nowD.getMinutes().toString();
